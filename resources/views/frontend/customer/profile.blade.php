                ...
                <div class="col-lg-6 text-lg-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb justify-content-lg-end mb-0 px-0">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('customer.profile') }}">{{ __('Profile') }}</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12 text-center mb-4">
                            @if (auth()->user()->user_image != '')
                                ...
                                <div class="mt-2">
                                    <a href="{{ route('customer.remove_profile_image') }}" class="btn btn-sm btn-outline-danger">{{ __('Remove image') }}</a>
                                </div>
                            @else
