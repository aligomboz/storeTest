                        ...
                        <div wire:ignore class="p-5 my-md-4">
                            ...
                            <div class="row align-items-stretch mb-4">
                                <div class="col-sm-7 pr-sm-0">
                                    <div class="border d-flex align-items-center justify-content-between py-1 px-3"><span class="small text-uppercase text-gray mr-4 no-select">{{ __('Quantity') }}</span>
                                        <div class="quantity">
                                ...
                                <div class="col-sm-5 pl-sm-0">
                                    <a style="color: white" wire:click="addToCart()" class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0">
                                        {{ __('Add to cart') }}
                                    </a>
                                </div>
                            </div>
                            <a wire:click="addToWishList()" class="btn btn-link text-dark p-0">
                                <i class="far fa-heart mr-2"></i>{{ __('Add to wish list') }}
                            </a>
                        </div>
                    </div>
                </div>
